...
namespace YasuoBuddy
{
    static class ColourMenuItem
    {
        ...
        {
            var a = menu.Add(uniqueId, new Slider("Renk Secici: ", defaultColour, 0, Colours.Count() - 1));
            a.DisplayName = "Renk Secici: " + ColoursName[a.CurrentValue];
            a.OnValueChange += delegate { a.DisplayName = "Renk Secici: " + ColoursName[a.CurrentValue]; };
        }
