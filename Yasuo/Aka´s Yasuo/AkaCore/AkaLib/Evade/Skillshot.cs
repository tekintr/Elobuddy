    ...
    public class Skillshot
    {
        ...
        public bool Evade
        {
            get
            {
                ...
                if (Extensions.GameTimeTickCount - this.cachedValueTick < 100)
                {
                    return this.cachedValue;
                }
                this.cachedValue = Manager.MenuManager.EEnabled.Cast<CheckBox>().CurrentValue;
                this.cachedValueTick = Extensions.GameTimeTickCount;
                return this.cachedValue;
            }
        }
        ...
        public bool IsActive
        {
            get
            {
                return this.SpellData.MissileAccel != 0
                           ? Extensions.GameTimeTickCount <= this.StartTick + 5000
                           : Extensions.GameTimeTickCount
