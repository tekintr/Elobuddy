...
namespace AimBot
{
    internal static class Program
    {
        ...
        private static void Load()
        {
            ...
            {
                Menu.AddGroupLabel(slot + " Ayarlari");
                SlotsComboBox[slot] = Menu.Add(slot + "ComboBox", new ComboBox("Kullan", new List<string> { "Asla", "Komboda", "Her Zaman" }, 2));
                SlotsSlider[slot] = Menu.Add(slot + "HitChancePercent", new Slider("Isabet Orani", 60));
            }
            ...
            Drawing.OnDraw += delegate
            {
                ...
                {
                    Drawing.DrawText(MyHero.Position.WorldToScreen(), Color.White, "AIMbot " + (Enabled ? "Acik" : "Kapali"), 10);
                }
            };
        }
