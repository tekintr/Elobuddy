...
namespace MasterMind.Components
{
    public sealed class CooldownTracker : IComponent
    {
        ...
        public void InitializeComponent()
        {
            ...
            Menu.AddLabel("Buyulerin bekleme surelerini gosterir.");
            ...
            TrackAllies = Menu.Add("allies", new CheckBox(string.Format("Takip et {0}", MasterMind.IsSpectatorMode ? "mavi takim" : "dostlar")));
            TrackEnemies = Menu.Add("enemies", new CheckBox(string.Format("Takip et {0}", MasterMind.IsSpectatorMode ? "kirmisi takim" : "dusmanlar")));
            DrawSummoners = Menu.Add("summoners", new CheckBox("Goster buyuleri"));
            DrawText = Menu.Add("cooldownText", new CheckBox("Buyu gostergesi altinda geridonus suresi cizin"));
