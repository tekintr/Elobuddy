...
namespace MasterMind.Components
{
    public sealed class MapHack : IComponent
    {
        ...
        public void InitializeComponent()
        {
            ...
            Menu.AddLabel("Map Hack'i etkinlestirmek, dusmanin son konumunu gormenize olanak tanir.");
            Menu.AddLabel("Dusmanin mevcut hareket hiziyla nerede olabilecegini de gorebilirsiniz,");
            Menu.AddLabel("Hem geri cagirma hem de gorunmez olduklari zaman.");
            Menu.AddLabel("Her zaman olduğu gibi, her sey son derece yapilandirilabilir.");
            Menu.AddSeparator();

            Menu.AddGroupLabel("Options");
            DrawGlobal = Menu.Add("global", new CheckBox("Cizimler Aktif"));
            DrawRecallCircle = Menu.Add("recall", new CheckBox("Geri donunce cember goster"));
            DrawMovementCircle = Menu.Add("movement", new CheckBox("Hareket cemberi ciz"));
            DrawInvisibleTime = Menu.Add("time", new CheckBox("Kayip oldugu sureyi goster"));
            Menu.AddSeparator();

            Menu.AddGroupLabel("Adjustments");
            DelayInvisibleTime = Menu.Add("timeDelay", new Slider("Dusmanin gorunmez olmasinin ardindan zamanlayiciyi göster {0} second(s)", 10, 0, 30));
            RangeCircleDisableRange = Menu.Add("disableRange", new Slider("Cemberi devre disi birak su {0}0 uzaklikta", 800, 200, 2000));
