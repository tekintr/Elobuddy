...
namespace MasterMind
{
    public static class MasterMind
    {
        ...
        private static void OnLoadingComplete(EventArgs args)
        {
            ...
            Menu.AddGroupLabel("Kaliteli oyun yardimi icin cozumunuz olan MasterMind'e hos geldiniz.");
            Menu.AddLabel("Bu eklenti, oyununuzu gelistirecek bazi düzgün ozellikler sunar");
            Menu.AddLabel("without dropping FPS or gameplay fun.");
            Menu.AddSeparator();
            Menu.AddLabel("Bu eklentinin sundugu ozelliklere alt menulerden birine goz atin, eglenin!");
