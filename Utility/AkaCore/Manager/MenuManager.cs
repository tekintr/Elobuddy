...
namespace AkaCore.Manager
{
    class MenuManager
    {
        ...
        private static void Hauptmenu()
        {
            ...
            HMenu.AddGroupLabel("Addonlarim icin uzanti.");
        }
        ...
        private static void Activatormenu()
        {
            ...
            ActivatorMenu.Add("Qss", new CheckBox("Kullan civali"));
            ActivatorMenu.Add("Mecurial", new CheckBox("Kullan Mecurial"));
            ActivatorMenu.Add("Cleanser", new CheckBox("Kullan temizlemede"));
            ...
            ActivatorMenu.Add("Stun",
                new CheckBox("Sabitlenince"));
            ActivatorMenu.Add("Snare",
                new CheckBox("Yakalanma"));
        ...
        private static void Utilitymenu()
        {
            ...
            UtilityMenu.Add("SkinID", new Slider("Skin Sec", 0, 0, 15));
            ...
            UtilityMenu.Add("Autobuy", new CheckBox("Oto item al Baslangicda"));
            ...
            UtilityMenu.Add("AutobuytS", new ComboBox("Yukselt", 0, "Uzak gorus", "Tarayici"));
        ...
        private static void Orbwalkermenu()
        {
            ...
            if (ObjectManager.Player.ChampionName == "Draven")
            {
                ...
                OrbwalkerMenu.Add("Qmode", new ComboBox("Balta tutma modu", 1, "Komboda", "Surekli", "Hic"));
                OrbwalkerMenu.Add("Qrange", new Slider("Balta tutma Mesefesi:", 800, 120, 1500));
                OrbwalkerMenu.Add("WforQ", new CheckBox("Balta uzakta ise W kullan"));
                OrbwalkerMenu.AddGroupLabel("Safety Options");
                OrbwalkerMenu.Add("Qturret", new CheckBox("Balta tutma kule altinda"));
                OrbwalkerMenu.Add("Qenemies", new CheckBox("Balta tutma dusman grubunda"));
                OrbwalkerMenu.Add("Qkill", new CheckBox("Olucekse balta tutma"));
                OrbwalkerMenu.Add("Qmelee", new CheckBox("balta tutma yakininda melees"));
        ...
        private static void FPSMenu()
        {
            ...
            FPS.Add("minfps", new Slider("En az Fps", 45, 1, 350));
