namespace CowAwareness.Trackers
{
    ...
    public class Cooldown : Feature
    {
        ...
        {
            this.Menu.AddLabel("Skill ve buyulerin bekleme surelerini gosterir");

            this.Menu.Add("allies", new CheckBox("Takim goster"));
            this.Menu.Add("enemies", new CheckBox("Dusman goster"));
            this.Menu.Add("self", new CheckBox("Benim goster"));
