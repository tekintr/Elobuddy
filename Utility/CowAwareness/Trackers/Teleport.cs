namespace CowAwareness.Trackers
{
    ...
    public class Teleport : Feature, IToggleFeature
    {
        ...
        {
            this.Menu.AddLabel("Geri donus ve isinlanmalar");
            ...
            this.Menu.Add("allies", new CheckBox("Dostlarin donusunu goster", false));
            this.Menu.Add("self", new CheckBox("Benim donusumu goster", false));
            this.Menu.Add("enemies", new CheckBox("Dusmanin donusunu goster", false));
