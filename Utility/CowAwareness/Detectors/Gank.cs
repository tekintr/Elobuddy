namespace CowAwareness.Detectors
{
    ...
    public class Gank : Feature, IToggleFeature
    {
        ...
        {
            this.Menu.AddLabel("Gang atanlari algilar");

            this.Menu.Add("range", new Slider("Uzaklik", 3000, 1100, 5000));
            this.Menu.Add("cooldown", new Slider("Sakinlik", 10, 0, 30));
            this.Menu.Add("duration", new Slider("Sure", 10, 0, 30));
            this.Menu.Add("ping", new CheckBox("Ping (Yerel)"));
