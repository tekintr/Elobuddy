namespace CowAwareness.Drawings
{
    ...
    public class Clock : Feature, IToggleFeature
    {
        ...
        {
            this.Menu.AddLabel("Ekranda bir sistem zaman saati cizer");
            this.Menu.Add("topOffset", new Slider("Ust Offset", 75, 0, 500));
            this.Menu.Add("rightOffset", new Slider("Sag Offset", 100, 0, 500));
        }
