    ...
    public static class Config
    {
        ...
        public static class Modes
        {
            ...
            public static class Combo
            {
                ...
                static Combo()
                {
                    ...
                    _extraRangeQ = Menu.Add("comboExtraRangeQ", new Slider("Fazladan Menzil Q", 200, 0, 200));
                }
            ...
            public static class Harass
            {
                ...
                static Harass()
                {
                    ...
                    _extraRangeQ = Menu.Add("harassExtraRangeQ", new Slider("Fazladan Menzil Q", 200, 0, 200));
                    _mana = Menu.Add("harassMana", new Slider("Mana kullanimi (%)", 30));
                }
            ...
            public static class LaneClear
            {
                ...
                static LaneClear()
                {
                    ...
                    _hitNumQ = Menu.Add("laneHitQ", new Slider("Kac minyona carpsin Q", 3, 1, 10));
                    _hitNumW = Menu.Add("laneHitW", new Slider("Kac minyona carpsin W", 3, 1, 10));
                    _mana = Menu.Add("laneMana", new Slider("Mana kullanimi (%)", 30));
                }
        ...
        public static class Ultimate
        {
            ...
            public static readonly string[] AvailableModes =
            {
                ...
                "Acikca script",
                "Fare yakinina",
                "Tusa basildiginda (oto)",
                "Tusa basildiginda (fareye)"
            };
            ...
            static Ultimate()
            {
                ...
                _enabled = Menu.Add("enabled", new CheckBox("Asagidaki Ayarlari Etkinlestir"));
        ...
        public static class Misc
        {
            ...
            static Misc()
            {
                ...
                _gapcloser = Menu.Add("miscGapcloseE", new CheckBox("Atilanlara oto E at"));
                _interrupter = Menu.Add("miscInterruptE", new CheckBox("Tehlikeli buyuleri engellerken E"));
                _alerter = Menu.Add("miscAlerter", new CheckBox("R ile olucek var ise beni uyar"));
            }
        ...
        public static class Drawing
        {
            ...
            static Drawing()
            {
                ...
                _healthbar = Menu.Add("healthbar", new CheckBox("Saglik cubugu"));
                _percent = Menu.Add("percent", new CheckBox("Verilicek hasar"));
            }
