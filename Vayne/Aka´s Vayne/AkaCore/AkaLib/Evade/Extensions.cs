...
namespace AkaCore.AkaLib.Evade
{
    ...
    {
        public static Random Random = new Random(Extensions.TickCount);
        ...
        public static List<Vector2> GetWaypoints(this Obj_AI_Base unit)
        {
            ...
            else if (WaypointTracker.StoredPaths.ContainsKey(unit.NetworkId))
            {
                ...
                var timePassed = (Extensions.TickCount - WaypointTracker.StoredTick[unit.NetworkId]) / 1000f;
    ...
    public static class DelayAction
    {
        ...
        private static void GameOnOnGameUpdate(EventArgs args)
        {
            ...
            {
                if (ActionList[i].Time <= Extensions.GameTimeTickCount)
                {
                    try
                    {
        ...
        public struct Action
        {
            ...
            {
                Time = time + Extensions.GameTimeTickCount;
