        ...
        public static bool Check()
        {
            Task.Factory.StartNew(() =>
            {
                try
                {
                    ...
                    string OnlineVersion = new WebClient().DownloadString("https://github.com/tekintr/YeniTurkce/tree/master/Warwick/ReWarwick/Re" + champ + "/Re" + champ + "/Properties/AssemblyInfo.cs");
