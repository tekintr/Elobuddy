...
namespace LeeSinBuddy
{
    internal class WardJumper
    {
        ...
        public static void Init()
        {
            ...
            WardjumpMenu = Program.menu.AddSubMenu("Toteme Gitme Ayarlari", "wardJumpSettings");
            WardjumpMenu.AddGroupLabel("Toteme Gitme Ayarlari");
            var a = WardjumpMenu.Add("alwaysMax", new CheckBox("Her zaman en uzun mesafeye atil"));
            var b = WardjumpMenu.Add("onlyToCursor", new CheckBox("Her zaman fareye atil", false));
            ...
            WardjumpMenu.AddLabel("Zaman Degisiklikleri");
            WardjumpMenu.Add("checkTime", new Slider("Pozisyon yenileme suresi (ms)", 100, 1, 2000));
            WardjumpMenu.AddSeparator();
            WardjumpMenu.AddLabel("Tus ayarlari");

            var wj = WardjumpMenu.Add("wardjumpKeybind",
                new KeyBind("toteme Gitme tusu", false, KeyBind.BindTypes.HoldActive, 'Z'));

            WardjumpMenu.Add("drawWJ", new CheckBox("Goster toteme gitme menzili"));
