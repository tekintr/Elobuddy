...
namespace LeeSinBuddy
{
    class Smiter
    {
        ...
        {
            SmiteMenu = Program.menu.AddSubMenu("Carp Ayarlari");
            SmiteMenu.AddGroupLabel("Carp Ayarlari");
            SmiteMenu.AddLabel("Kombo Ayarlari");
            SmiteMenu.Add("smiteQ", new CheckBox("Q -> Carp"));
            SmiteMenu.AddLabel("Settings");
            SmiteMenu.Add("smiteEnabled", new KeyBind("Carp Aktif", false, KeyBind.BindTypes.PressToggle, 'H'));
            SmiteMenu.Add("regularSmite", new CheckBox("Duzgun Carp"));
            SmiteMenu.Add("QSmite", new CheckBox("Q => Carp => Q"));
            SmiteMenu.Add("drawSmite", new CheckBox("Goster Carp Menzili"));
            SmiteMenu.AddLabel("Kamplar");
            SmiteMenu.Add("SRU_Red", new CheckBox("Kirmisi"));
