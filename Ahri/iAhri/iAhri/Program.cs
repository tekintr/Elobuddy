...
namespace iAhri
{
    internal class Program
    {
        ...
        private static void OnLoad(EventArgs args)
        {
            ...
            Chat.Print(AddonName + " made by " + Author + " Yuklendi, Ceviri TekinTR!.");
            ...
            SubMenu["Combo"].Add("W", new CheckBox("Kullan W", true));
            SubMenu["Combo"].Add("E", new CheckBox("Kullan E", true));
            SubMenu["Combo"].Add("R", new CheckBox("Kullan R", true));
            SubMenu["Combo"].Add("CatchQR", new CheckBox("Q yu R ile yakala", true));
            SubMenu["Combo"].Add("CatchQRPriority", new CheckBox("Q yu R ile yakalamak icin oncelik ver", true));

            SubMenu["Harass"] = menu.AddSubMenu("Harass", "Harass");
            SubMenu["Harass"].Add("Q", new CheckBox("Kullan Q", true));
            SubMenu["Harass"].Add("W", new CheckBox("Kullan W", false));
            SubMenu["Harass"].Add("E", new CheckBox("Kullan E", false));
            SubMenu["Harass"].Add("Mana", new Slider("Gereken enaz mana:", 20, 0, 100));
            ...
            SubMenu["JungleClear"].Add("Mana", new Slider("Gereken enaz mana:", 20, 0, 100));

            SubMenu["KillSteal"] = menu.AddSubMenu("KillSteal", "KillSteal");
            SubMenu["KillSteal"].Add("Q", new CheckBox("Kullan Q", true));
            SubMenu["KillSteal"].Add("W", new CheckBox("Kullan W", true));
            ...
            SubMenu["Flee"].Add("Q", new CheckBox("Kullan Q", true));
            SubMenu["Flee"].Add("R", new CheckBox("Kullan R", true));

            SubMenu["Draw"] = menu.AddSubMenu("Drawing", "Drawing");
            SubMenu["Draw"].Add("Line", new CheckBox("Q orb icin ciz", true));

            SubMenu["Misc"] = menu.AddSubMenu("Misc", "Misc");
            SubMenu["Misc"].Add("Overkill", new Slider("Oldurme icin % hasar tahmini", 10, 0, 100));
            SubMenu["Misc"].Add("CatchQMovement", new CheckBox("Q yu hareket ile yakala", false));
            SubMenu["Misc"].Add("Gapclose", new CheckBox("Atilma yapanlara E kullan", true));
            SubMenu["Misc"].Add("Channeling", new CheckBox("Buyuleri engellemede E kullan", true));
