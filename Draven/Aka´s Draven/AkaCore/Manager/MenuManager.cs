    ...
    class MenuManager
    {
        ...
        private static void Orbwalkermenu()
        {
            ...
            if (ObjectManager.Player.ChampionName == "Draven")
            {
                ...
                OrbwalkerMenu.Add("Qrange", new Slider("Balta yakalama menzili:", 800, 120, 1500));
                OrbwalkerMenu.Add("WforQ", new CheckBox("Kullan W balta uzaga dusmusse"));
                OrbwalkerMenu.AddGroupLabel("Safety Options");
                OrbwalkerMenu.Add("Qturret", new CheckBox("Kule altinda balta tutmaz"));
                OrbwalkerMenu.Add("Qenemies", new CheckBox("Dusman icinde balta tutmaz"));
                OrbwalkerMenu.Add("Qkill", new CheckBox("Olucek varsa balta tutmaz"));
                OrbwalkerMenu.Add("Qmelee", new CheckBox("Savasci(Yakin menzil) varsa balta tutmaz"));
