        ...
        public static bool Check()
        {
            Task.Factory.StartNew(() =>
            {
                try
                {
                    ...
                    string OnlineVersion = new WebClient().DownloadString("https://github.com/tekintr/YeniTurkce/tree/master/Katarina/ReKatarina/Re" + champ + "/Re" + champ + "/Properties/AssemblyInfo.cs");
