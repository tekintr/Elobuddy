...
namespace HTTF_TopLane_Series.DataChampion
{
    class Shen3
    {
        ...
        public static void Loading_OnLoadingComplete(EventArgs args)
        {
            ...
            ComboMenu.Add("QCast", new CheckBox("Kullan Q"));
            ComboMenu.Add("autow", new CheckBox("Kullan W"));
            ComboMenu.Add("useECombo", new CheckBox("Kullan E"));

            ComboMenu.AddGroupLabel("E Ayari");
            ComboMenu.Add("eslider", new Slider("Enaz kac dusmana isabet etsin", 1, 1, 5));
            foreach (var obj in ObjectManager.Get<AIHeroClient>().Where(obj => obj.Team != obj.Team))
            {
                ComboMenu.Add("taunt" + obj.ChampionName.ToLower(), new CheckBox("Kiskirtma " + obj.ChampionName));
            }
            ComboMenu.Add("ekey", new KeyBind("Kullan E", false, KeyBind.BindTypes.HoldActive, 'N'));
            ComboMenu.Add("flashe", new KeyBind("Sicra E", false, KeyBind.BindTypes.HoldActive, 'N'));

            ComboMenu.AddGroupLabel("R Ayari");

            ComboMenu.Add("autoult", new CheckBox("Otomatik R tusa basildiginda?"));
            ComboMenu.Add("rslider", new Slider("Ulti kullanmak icin kalan HP", 20));
            ...
            JungleLaneMenu = Menu.AddSubMenu("Temizleme Ayari", "FarmAyari");
            ...
            MiscMenu.Add("TUT", new CheckBox("Kule altinda otomatik kiskirtma"));
            MiscMenu.Add("inte", new CheckBox("Skill engellemede E"));
            MiscMenu.AddGroupLabel("Kacis Ayarlari");
            MiscMenu.Add("fleee", new CheckBox("Kullan E"));

            DrawMenu = Menu.AddSubMenu("Cizim Ayarlari", "CizimAyarlari");
            DrawMenu.Add("drawe", new CheckBox("Goster E Mesafesi"));
            DrawMenu.Add("drawfe", new CheckBox("Goster Sicra+E Mesafesi"));
