...
namespace Marksman_Master.Plugins.Lucian
{
    ...
    internal class Lucian : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Lucian.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.Add("Plugins.Lucian.ComboMenu.ExtendQOnMinions", new CheckBox("Minyonlar uzerinden Q kullan"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Ardent Blaze (W) settings :");
            ComboMenu.Add("Plugins.Lucian.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.Add("Plugins.Lucian.ComboMenu.IgnoreCollisionW", new CheckBox("Carpismayi yoksay"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Relentless Pursuit (E) settings :");
            ComboMenu.Add("Plugins.Lucian.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("The Culling (R) settings :");
            ComboMenu.Add("Plugins.Lucian.ComboMenu.UseR", new CheckBox("Kullan R"));
            ...
            HarassMenu.Add("Plugins.Lucian.HarassMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) Q kullanmak icin", 80, 1));
            ...
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Yakinda dusman yoksa koridor temizlmeme aktif"));
            var scanRange = LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Piercing Light (Q) settings :");
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.UseQInLaneClear", new CheckBox("Kullan Q Koridor temizleme"));
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.MinMinionsHitQ", new Slider("Q ile kesilicek en az minyon sayisi", 3, 1, 8));
            LaneClearMenu.AddSeparator(5);
            
            LaneClearMenu.AddGroupLabel("Jungle Clear : ");
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.UseQInJungleClear", new CheckBox("Ormanda Q kullan"));
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.UseWInJungleClear", new CheckBox("Ormanda W kullan"));
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.UseEInJungleClear", new CheckBox("Ormanda E kullan"));
            LaneClearMenu.Add("Plugins.Lucian.LaneClearMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) orman temizlemede", 50, 1));
            ...
            MiscMenu.Add("Plugins.Lucian.MiscMenu.EnableKillsteal", new CheckBox("Oldurme sekli aktif"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Relentless Pursuit (E) settings :");
            MiscMenu.Add("Plugins.Lucian.MiscMenu.EUsageMode", new ComboBox("E kullanimi", 0, "Surekli", "Sadece oto ataktan sonra"));

            DrawingsMenu = MenuManager.Menu.AddSubMenu("Drawings");
            DrawingsMenu.AddGroupLabel("Drawings settings for Lucian addon");

            DrawingsMenu.AddLabel("Basic settings :");
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.DrawSpellRangesWhenReady", new CheckBox("Sadece hazir olan buyuleri goster"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("Piercing Light (Q) settings :");
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili"));
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.DrawQColor", new CheckBox("Renk sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.DrawR", new CheckBox("Goster R menzili"));
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.DrawRColor", new CheckBox("Renk sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.DrawInfo", new CheckBox("Goster bilgi")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Lucian.DrawingsMenu.InfoColor", new CheckBox("Renk sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
