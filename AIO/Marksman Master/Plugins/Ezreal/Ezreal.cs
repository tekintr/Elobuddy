...
namespace Marksman_Master.Plugins.Ezreal
{
    internal class Ezreal : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.UseQOnImmobile", new CheckBox("Kacamayan dusmanlara kullan"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Essence Flux (W) settings :");
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Arcane Shift (E) settings :");
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.UseE", new CheckBox("Kullan E"));
            ...
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.UseR", new CheckBox("Kullan R"));
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.UseRToKillsteal", new CheckBox("Sadece kesiliceklere R kullan"));
            ComboMenu.Add("Plugins.Ezreal.ComboMenu.RMinEnemiesHit", new Slider("R kullanınca carpicak {0} dusman sayisi", 3, 1, 5));
            ...
            HarassMenu.Add("Plugins.Ezreal.HarassMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) otomatik durtme icin", 30, 1));
            ...
            LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Yakinda dusman yoksa koridor temizle", false));
            var scanRange = LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("End of the Line (Q) settings :");
            LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.UseQInLaneClear", new CheckBox("Koridor temizlemede Q kullan"));
            LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.LaneClearQMode", new ComboBox("Koridorda Q modu : ", 0, "Son vurus", "Ittirme"));
            LaneClearMenu.AddSeparator(5);
            LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.UseQInJungleClear", new CheckBox("Orman temizlemede Q kullan"));
            LaneClearMenu.Add("Plugins.Ezreal.LaneClearMenu.MinManaQ", new Slider("En az mana ({0}%) Q kullanmak icin", 50, 1));
            ...
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.EnableKillsteal", new CheckBox("Oldurme sekli aktif"));
            MiscMenu.AddSeparator(2);
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.KeepPassiveStacks", new CheckBox("Mumkunse pasif birikmis olarak tut"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Essence Flux (W) settings :");
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.WToPushTowers", new CheckBox("Kule itmek icin W kullan"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Arcane Shift (E) settings :");
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.EAntiMelee", new CheckBox("Kavgada sampiyonlara E kullan"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Trueshot Barrage (R) settings :");
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.MaxRRangeKillsteal", new Slider("R ile en fazla oldurme uzakligi", 8000, 0, 20000));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Tear Stacker settings :");
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.EnableTearStacker", new CheckBox("Gosyasi kasma etkin")).OnValueChange +=
                (a, b) =>
                {
            ...
            MiscMenu.Add("Plugins.Ezreal.MiscMenu.MinimalManaPercentTearStacker", new Slider("Gereken en az mana ({0}%) gozyasi kasmak icin",  50)).OnValueChange +=
                (a, b) =>
                {
            ...
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawSpellRangesWhenReady", new CheckBox("Hazir olan buyulerin saldiri menzilini ciz"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("Mystic Shot (Q) settings :");
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili"));
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawQColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawW", new CheckBox("Goster W menzili", false));
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawWColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawE", new CheckBox("Goster E menzili", false));
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawEColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DrawDamageIndicator", new CheckBox("Verilebilicek hasari goster")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Ezreal.DrawingsMenu.DamageIndicatorColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
