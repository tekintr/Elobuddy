...
namespace Marksman_Master.Plugins.Kalista
{
    internal class Kalista : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Kalista.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Rend (E) settings :");
            ComboMenu.Add("Plugins.Kalista.ComboMenu.UseE", new CheckBox("Kullan E yavaslatma"));
            ComboMenu.Add("Plugins.Kalista.ComboMenu.UseEBeforeDeath", new CheckBox("Kullan E olmeden once"));
            ComboMenu.AddSeparator(1);
            ComboMenu.Add("Plugins.Kalista.ComboMenu.UseEBeforeEnemyLeavesRange",
                new CheckBox("E yukeri silinmeden once dusmana E kullan", false));
            ComboMenu.Add("Plugins.Kalista.ComboMenu.UseEBeforeEnemyLeavesRangeS",
                new Slider("En az dusman canina ({0}%) verilicek hasar", 50, 15, 99));
            ComboMenu.AddLabel(
            ...
            ComboMenu.Add("Plugins.Kalista.ComboMenu.JumpOnMinions", new CheckBox("Minyon kullanarak sicra"));
            ...
            HarassMenu.Add("Plugins.Kalista.HarassMenu.UseQ", new CheckBox("Kullan Q"));
            HarassMenu.Add("Plugins.Kalista.HarassMenu.MinManaForQ",
                new Slider("Gereken mana miktari ({0}%) Q kullanmak icin", 50, 1));
            HarassMenu.AddSeparator(5);

            HarassMenu.AddLabel("Rend (E) settings :");
            HarassMenu.Add("Plugins.Kalista.HarassMenu.UseE", new CheckBox("Kullan E"));
            HarassMenu.Add("Plugins.Kalista.HarassMenu.UseEIfManaWillBeRestored",
                new CheckBox("Sadece mana geri yuklenicekse E kullan"));
            HarassMenu.Add("Plugins.Kalista.HarassMenu.MinManaForE",
                new Slider("Gereken mana miktari ({0}%) E kullanmak icin", 50, 1));
            HarassMenu.Add("Plugins.Kalista.HarassMenu.MinStacksForE", new Slider("E icin en az yuk", 3, 2, 12));
            ...
            JungleLaneClearMenu.Add("Plugins.Kalista.JungleLaneClearMenu.MinMinionsForQ",
                new Slider("Q ile kesilicek en az minyon sayisi", 3, 1, 6));
            ...
            JungleLaneClearMenu.Add("Plugins.Kalista.JungleLaneClearMenu.UseEForUnkillable",
                new CheckBox("Kesilemiyecek minyonlara E ile son vurus"));
            JungleLaneClearMenu.Add("Plugins.Kalista.JungleLaneClearMenu.MinManaForE",
                new Slider("Gereken mana miktari ({0}%) E icin", 50, 1));
            JungleLaneClearMenu.Add("Plugins.Kalista.JungleLaneClearMenu.MinMinionsForE",
                new Slider("E ile kesilicek en az minyon sayisi", 3, 1, 6));
            JungleLaneClearMenu.AddSeparator(5);
            ...
            JungleLaneClearMenu.Add("Plugins.Kalista.JungleLaneClearMenu.UseEToStealBuffs",
                new CheckBox("Yaratik calmada E kullan"));
            JungleLaneClearMenu.Add("Plugins.Kalista.JungleLaneClearMenu.UseEToStealDragon",
                new CheckBox("Ejder / Baron calmada E kullan"));
            ...
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawSpellRangesWhenReady",
                new CheckBox("Sadece hazir olan buyulerin menzilini ciz"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("Pierce (Q) drawing settings :");
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili"));
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawQColor", new CheckBox("Renk Sec", false))
                .OnValueChange += (a, b) =>
                {
                    if (!b.NewValue)
                        return;
            ...
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawE", new CheckBox("Goster E menzili"));
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawEColor", new CheckBox("Renk Sec", false))
                .OnValueChange += (a, b) =>
                {
                    if (!b.NewValue)
                        return;
            ...
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawR", new CheckBox("Goster R menzili"));
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawRColor", new CheckBox("Renk Sec", false))
                .OnValueChange += (a, b) =>
                {
                    if (!b.NewValue)
                        return;
            ...
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawDamageIndicator",
                new CheckBox("Dusmana verilebilicek hasari goster")).OnValueChange += (a, b) =>
                {
                    if (b.NewValue)
                        DamageIndicator.DamageDelegate = HandleDamageIndicator;
                    else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DrawDamageIndicatorColor",
                new CheckBox("Renk Sec", false)).OnValueChange +=
                (a, b) =>
                {
                    if (!b.NewValue)
                        return;
            ...
            DrawingsMenu.Add("Plugins.Kalista.DrawingsMenu.DamageIndicatorMode", new ComboBox("Hasar gosterge", 0, "Sadece E hasari", "Kombo hasari"));
            ...
            MiscMenu.Add("Plugins.Kalista.MiscMenu.BlitzCombo", new CheckBox("Aktif Blitzcrank kombosu", false));
