...
#region Q
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Vayne.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.Add("Plugins.Vayne.ComboMenu.TryToQE", new CheckBox("Dene Q => E"));
            ComboMenu.AddLabel("Vanyne will try to use Q to set herself in position that will let you condemn the target.");
            ComboMenu.AddSeparator(5);

            ComboMenu.Add("Plugins.Vayne.ComboMenu.UseQToPoke", new CheckBox("Kullan Q durtmede"));
            ComboMenu.AddSeparator(5);

            ComboMenu.Add("Plugins.Vayne.ComboMenu.UseQOnlyToProcW", new CheckBox("Sadece W yukleri icin Q kullan", false));
            ComboMenu.AddSeparator(5);

            ComboMenu.Add("Plugins.Vayne.ComboMenu.BlockQsOutOfAARange", new CheckBox("Hedef menzilden cikarsa Q kullanma", false));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Condemn (E) settings :");
            ComboMenu.Add("Plugins.Vayne.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.AddSeparator(5);

            ComboMenu.Add("Plugins.Vayne.ComboMenu.UseEAgainstMelee", new CheckBox("Yakin dovus sampiyona E kullan"));
            ...
            ComboMenu.Add("Plugins.Vayne.ComboMenu.UseR", new CheckBox("Kullan R", false));
            ComboMenu.AddSeparator(5);
            ...
            HarassMenu.Add("Plugins.Vayne.HarassMenu.UseQ", new CheckBox("Kullan Q"));
            HarassMenu.Add("Plugins.Vayne.HarassMenu.MinManaToUseQ", new Slider("Gereken en az mana ({0}%) to use Q", 50, 1));
            HarassMenu.AddSeparator(5);

            HarassMenu.AddLabel("Condemn (E) settings :");
            HarassMenu.Add("Plugins.Vayne.HarassMenu.UseE", new CheckBox("Kullan E 3yuk patlatmada"));
            HarassMenu.Add("Plugins.Vayne.HarassMenu.MinManaToUseE", new Slider("Gereken en az mana ({0}%) to use E", 80, 1));
            ...
            LaneClearMenu.Add("Plugins.Vayne.LaneClearMenu.EnableLCIfNoEn",
                new CheckBox("Yakinda dusman yoksa koridor temizleme aktif"));
            var scanRange = LaneClearMenu.Add("Plugins.Vayne.LaneClearMenu.ScanRange",
                new Slider("Dusman uzakligi", 1500, 0, 2500));
            ...
            LaneClearMenu.Add("Plugins.Vayne.LaneClearMenu.UseQToLaneClear", new CheckBox("Koridor temizlemede Q kullan"));
            LaneClearMenu.Add("Plugins.Vayne.LaneClearMenu.UseQToJungleClear", new CheckBox("Orman temizlemede Q kullan"));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Condemn (E) settings :");
            LaneClearMenu.Add("Plugins.Vayne.LaneClearMenu.UseE", new CheckBox("Ormanda E kullan"));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Mana settings :");
            LaneClearMenu.Add("Plugins.Vayne.LaneClearMenu.MinMana",
                new Slider("Gereken en az mana ({0}%) koridor ve orman temizlemede", 80, 1));
            ...
            MiscMenu.Add("Plugins.Vayne.MiscMenu.EAntiRengar", new CheckBox("Aktif Anti-Rengar"));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.EAntiFlash", new CheckBox("Sicra atana karsi"));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.Eks", new CheckBox("Kullan E ile oldurme"));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.UseTrinket", new CheckBox("Dusmanin son konumuna totem at"));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.PushDistance", new Slider("Itme mesafesi", 420, 400, 470));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.EHitchance", new Slider("E stan sansi : {0}%", 65));
            MiscMenu.AddLabel("More often condemn attempts the lower the Hitchance option is.");
            MiscMenu.AddSeparator(5);
            MiscMenu.Add("Plugins.Vayne.MiscMenu.EMode", new ComboBox("E Mode", 1, "Surekli", "Sadece Kombo"));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.EMethod", new ComboBox("E Method", 1, "Hizli", "Daha keskin", "Eski yontem"));
            MiscMenu.Add("Plugins.Vayne.MiscMenu.ETargeting", new ComboBox("E Hedefi", 0, "Secili Hedefe", "Butun dusmanlara"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Additional Tumble (Q) settings :");
            MiscMenu.Add("Plugins.Vayne.MiscMenu.QMode", new ComboBox("Q Mode", 0, "Fare yonu", "Oto"));
            var qDirection = MiscMenu.Add("Plugins.Vayne.MiscMenu.QDirection", new ComboBox("Q yonu", 0, "Her yerde", "Sadece Yan", "Sadece ileri / geri"));
            ...
            MiscMenu.Add("Plugins.Vayne.MiscMenu.QSafetyChecks", new CheckBox("Guvenlik kontrolleri etkinlestir")).OnValueChange +=
                (sender, args) =>
                {
            ...
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawInfo", new CheckBox("Goster W yuk alma bilgisi"));
            DrawingsMenu.AddSeparator(5);
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawPlayerBoundingRadius", new CheckBox("Goster oyuncu sinir yaricapi"));
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawPlayerBoundingRadiusColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawCurrentOrbwalkingTarget",new CheckBox("Goster secili orbwalker hedefini"));
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawCurrentOrbwalkingTargetColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
                {
                    if (!b.NewValue)
                        return;
            ...
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawCursorEndPosition", new CheckBox("Imlecin bitis noktasini ciz", false));
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawCursorEndPositionMode", new ComboBox("Gosterge mode", 0, "Daire", "Ok"));
            DrawingsMenu.Add("Plugins.Vayne.DrawingsMenu.DrawCursorEndPositionColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
