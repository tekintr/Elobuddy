...
namespace Marksman_Master.Plugins.Caitlyn
{
    internal class Caitlyn : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Yordle Snap Trap (W) settings :");
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.UseWOnImmobile", new CheckBox("Mobil olmayanlara W"));
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.WHitChancePercent", new Slider("W carpma sansi : {0}", 85));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("90 Caliber Net (E) settings :");
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.EHitChancePercent", new Slider("E carpma sansi : {0}", 65));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Ace in the Hole (R) settings :");
            ComboMenu.Add("Plugins.Caitlyn.ComboMenu.UseR", new CheckBox("Kullan R", false));
            ...
            HarassMenu.Add("Plugins.Caitlyn.HarassMenu.UseQ", new CheckBox("Kullan Q", false));
            HarassMenu.Add("Plugins.Caitlyn.HarassMenu.MinManaQ", new Slider("En az mana ({0}%) Q kullanmak icin", 75, 1));
            ...
            LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Yakinda dusman yoksa koridor temizle", false));
            var scanRange = LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman miktari", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Piltover Peacemaker (Q) settings :");
            LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.UseQInLaneClear", new CheckBox("Kullan Q koridor temizlemede"));
            LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.MinMinionsKilledForQ", new Slider("Q kullan en az kac minyon kesilcek", 3, 1, 6));
            LaneClearMenu.AddSeparator(5);
            LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.UseQInJungleClear", new CheckBox("Kullan Q orman temizlemede"));
            LaneClearMenu.Add("Plugins.Caitlyn.LaneClearMenu.MinManaQ", new Slider("En az mana ({0}%) Q kullanmak icin", 50, 1));
            ...
            MiscMenu.Add("Plugins.Caitlyn.MiscMenu.EnableKillsteal", new CheckBox("OldurmeSekli Aktif"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Yordle Snap Trap (W) settings :");
            MiscMenu.Add("Plugins.Caitlyn.MiscMenu.WAgainstGapclosers", new CheckBox("Atilan sampiyonlara W kullan"));
            
            MiscMenu.AddLabel("90 Caliber Net (E) settings :");
            MiscMenu.Add("Plugins.Caitlyn.MiscMenu.EAgainstGapclosers", new CheckBox("Atilan sampiyonlara E kullan"));
            ...
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawSpellRangesWhenReady", new CheckBox("Hazir olan buyulerin mesafesini goster"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("Piltover Peacemaker (Q) settings :");
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawQ", new CheckBox("Goster Q uzakligi"));
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawQColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawE", new CheckBox("Goster E uzakligi", false));
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawEColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawR", new CheckBox("Goster R uzakligi", false));
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawRColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DrawDamageIndicator", new CheckBox("Verilebilicek Hasari goster")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Caitlyn.DrawingsMenu.DamageIndicatorColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
