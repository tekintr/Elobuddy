...
namespace Marksman_Master.Plugins.Graves
{
    internal class Graves : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Graves.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Smoke Screen (W) settings :");
            ComboMenu.Add("Plugins.Graves.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Quickdraw (E) settings :");
            ComboMenu.Add("Plugins.Graves.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.Add("Plugins.Graves.ComboMenu.UseEOnlyToDardoch", new CheckBox("Yalnizca Dardoch hilesini uygulayabilirseniz E kullanin", false));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Collateral Damage (R) settings :");
            ComboMenu.Add("Plugins.Graves.ComboMenu.UseR", new CheckBox("Kullan R"));
            ComboMenu.Add("Plugins.Graves.ComboMenu.RMinEnemiesHit", new Slider("Carpmasi gereken dusman R {0} kullanmak icin", 0, 0, 5));
            ...
            HarassMenu.Add("Plugins.Graves.HarassMenu.UseQ", new CheckBox("Kullan Q", false));
            HarassMenu.Add("Plugins.Graves.HarassMenu.MinManaQ", new Slider("En az mana ({0}%) Q kullanmak icin", 80, 1));
            ...
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Yakinda dusman yoksa koridor temizle"));
            var scanRange = LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("End of the Line (Q) settings :");
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.UseQInLaneClear", new CheckBox("Koridor temizleme Q kullan"));
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.MinMinionsHitQ", new Slider("En az kac miyona Q carpsin", 3, 1, 8));
            LaneClearMenu.AddSeparator(5);
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.UseQInJungleClear", new CheckBox("Orman temizleme Q kullan"));
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.MinManaQ", new Slider("En az mana ({0}%) Q kullanmak icin", 50, 1));
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.UseEInJungleClear", new CheckBox("Orman temizleme E kullan"));
            LaneClearMenu.Add("Plugins.Graves.LaneClearMenu.MinManaE", new Slider("En az mana ({0}%) E kullanmak icin", 50, 1));
            ...
            MiscMenu.Add("Plugins.Graves.MiscMenu.EnableKillsteal", new CheckBox("Oldurme sekli aktif"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Quickdraw (E) settings :");
            MiscMenu.Add("Plugins.Graves.MiscMenu.EMode", new ComboBox("E mode", 0, "Oto", "Fareye dogru"));
            MiscMenu.Add("Plugins.Graves.MiscMenu.EUsageMode", new ComboBox("E Kullan", 1, "Surekli", "Sadece oto atakdan sonra"));

            DrawingsMenu = MenuManager.Menu.AddSubMenu("Drawings");
            DrawingsMenu.AddGroupLabel("Drawings settings for Graves addon");

            DrawingsMenu.AddLabel("Basic settings :");
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DrawSpellRangesWhenReady", new CheckBox("Hazir olan buyuleri goster"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("End of the Line (Q) settings :");
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili"));
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DrawQColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DrawR", new CheckBox("Goster R menzili"));
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DrawRColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DrawDamageIndicator", new CheckBox("Verilebilicek hasari goster")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Graves.DrawingsMenu.DamageIndicatorColor", new CheckBox("Rengi sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
