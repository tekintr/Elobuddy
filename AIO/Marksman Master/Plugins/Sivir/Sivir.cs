...
namespace Marksman_Master.Plugins.Sivir
{
    internal class Sivir : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Sivir.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Ricochet (W) settings :");
            ComboMenu.Add("Plugins.Sivir.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.AddSeparator(5);
            ...
            HarassMenu.Add("Plugins.Sivir.HarassMenu.UseQ", new CheckBox("Kullan Q"));
            HarassMenu.Add("Plugins.Sivir.HarassMenu.AutoHarass", new CheckBox("Kacamayan sampiyonlara oto durtme"));
            HarassMenu.Add("Plugins.Sivir.HarassMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) to use Q", 80, 1));
            HarassMenu.AddSeparator(5);

            HarassMenu.AddLabel("Ricochet (W) settings :");
            HarassMenu.Add("Plugins.Sivir.HarassMenu.UseW", new CheckBox("Kullan W"));
            HarassMenu.Add("Plugins.Sivir.HarassMenu.MinManaW", new Slider("Gereken en az mana ({0}%) to use W", 80, 1));
            HarassMenu.AddSeparator(5);
            ...
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Dusman yoksa koridor temizleme aktif"));
            var scanRange = LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Boomerang Blade (Q) settings :");
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.UseQInLaneClear", new CheckBox("Koridor temizlemede Q kullan"));
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.UseQInJungleClear", new CheckBox("Orman temizlemede Q kullan"));
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) to use Q", 80, 1));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Ricochet (W) settings :");
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.UseWInLaneClear", new CheckBox("Koridor temizlemede W kullan"));
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.UseWInJungleClear", new CheckBox("Orman temizlemede W kullan"));
            LaneClearMenu.Add("Plugins.Sivir.LaneClearMenu.MinManaW", new Slider("Gereken en az mana ({0}%) to use W", 80, 1));
            ...
            DrawingsMenu.Add("Plugins.Sivir.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili", false));
            DrawingsMenu.Add("Plugins.Sivir.DrawingsMenu.DrawQMissile", new CheckBox("Goster Q yonu"));
            DrawingsMenu.Add("Plugins.Twitch.DrawingsMenu.DrawQColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
