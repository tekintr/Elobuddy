...
namespace Marksman_Master.Plugins.Tristana
{
    internal class Tristana : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Rocket Jump (W) settings :");
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseW", new CheckBox("Kullan W", false));
            ComboMenu.AddLabel("Only if W - E - R combo will kill an enemy");
            ComboMenu.AddSeparator(2);
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseWVsGapclosers", new CheckBox("Kullan E atilma yapan sampiyonlara"));
            ...
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.AddSeparator(2);
            ComboMenu.Add("Plugins.Tristana.ComboMenu.FocusE", new CheckBox("Hedefe odaklan E ile"));
            ComboMenu.AddSeparator(5);
            ...
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseR", new CheckBox("Oldurmede R kullan"));
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseRVsMelees", new CheckBox("Savasirken R kullan"));
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseRVsInterruptible", new CheckBox("R kullanarak kes"));
            ComboMenu.Add("Plugins.Tristana.ComboMenu.UseRVsGapclosers", new CheckBox("Atilma yapan sampiyona R kullan"));
            ComboMenu.AddSeparator(5);
            ...
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Dusman yoksa koridor temizleme aktif"));
            var scanRange = LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Rapid Fire (Q) settings :");
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.UseQInLaneClear", new CheckBox("Koridor temizlemede Q kullan"));
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.UseQInJungleClear", new CheckBox("Orman temizlemede Q kullan"));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Explosive Charge (E) settings :");
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.UseEInLaneClear", new CheckBox("Koridor temizlemede E kullan"));
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.UseEInJungleClear", new CheckBox("Orman temizlemede E kullan"));
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.UseEOnTowers", new CheckBox("Kulelere E kullan"));
            LaneClearMenu.Add("Plugins.Tristana.LaneClearMenu.MinManaE", new Slider("Gereken en az mana ({0}%) to use E", 80, 1));
            ...
            DrawingsMenu.Add("Plugins.Tristana.DrawingsMenu.DrawSpellRangesWhenReady",
                new CheckBox("Sadece hazir olan buyuleri goster"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("Rocket Jump (W) settings :");
            DrawingsMenu.Add("Plugins.Tristana.DrawingsMenu.DrawW", new CheckBox("Goster W menzili"));
            DrawingsMenu.Add("Plugins.Tristana.DrawingsMenu.DrawWColor", new CheckBox("Renk sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Tristana.DrawingsMenu.DrawInfo", new CheckBox("Goster bilgi")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Tristana.DrawingsMenu.InfoColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
