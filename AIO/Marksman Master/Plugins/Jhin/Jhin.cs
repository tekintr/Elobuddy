...
namespace Marksman_Master.Plugins.Jhin
{
    internal class Jhin : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Jhin.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Deadly Flourish (W) settings :");
            ComboMenu.Add("Plugins.Jhin.ComboMenu.UseW", new CheckBox("Kullan W"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Captive Audience (E) settings :");
            ComboMenu.Add("Plugins.Jhin.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Curtain Call (R) settings :");
            ComboMenu.Add("Plugins.Jhin.ComboMenu.UseR", new CheckBox("Kullan R"));
            ComboMenu.Add("Plugins.Jhin.ComboMenu.EnableFowPrediction", new CheckBox("Fow tahmini etkinlestir"));
            ComboMenu.Add("Plugins.Jhin.ComboMenu.RDelay", new Slider("Mermilerin atis hizi", 0,  0, 2500));
            ComboMenu.Add("Plugins.Jhin.ComboMenu.RMode", new ComboBox("R mode", 0, "Kombo icinde", "KeyBind", "Otomatik"));
            ...
            HarassMenu.Add("Plugins.Jhin.HarassMenu.UseQ", new CheckBox("Kullan Q", false));
            HarassMenu.Add("Plugins.Jhin.HarassMenu.MinManaQ", new Slider("En az mana ({0}%) Q icin", 80, 1));
            HarassMenu.AddSeparator(5);

            HarassMenu.AddLabel("Deadly Flourish (W) settings :");
            HarassMenu.Add("Plugins.Jhin.HarassMenu.UseW", new CheckBox("Kullan W"));
            HarassMenu.Add("Plugins.Jhin.HarassMenu.MinManaW", new Slider("En az mana ({0}%) W icin", 80, 1));
            HarassMenu.AddSeparator(5);
            ...
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Yakinda dusman yoksa lane temizleme aktif"));
            var scanRange = LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Dancing Grenade (Q) settings :");
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.UseQInLaneClear", new CheckBox("Koridor temizlemede Q", false));
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.UseQInJungleClear", new CheckBox("Orman temizlemede Q"));
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.MinManaQ", new Slider("En az mana ({0}%) Q icin", 50, 1));
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.MinMinionsKilledFromQ", new Slider("En az kac minyon Q ile kesilsin", 3, 1, 4));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Deadly Flourish (W) settings :");
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.UseWInLaneClear", new CheckBox("Koridor temizlemede W"));
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.UseWInJungleClear", new CheckBox("Orman temizlemede W"));
            LaneClearMenu.Add("Plugins.Jhin.LaneClearMenu.MinManaW", new Slider("En az mana ({0}%) W icin", 50, 1));
            ...
            MiscMenu.Add("Plugins.Jhin.MiscMenu.EnableKillsteal", new CheckBox("Oldurme sekli aktif"));
            MiscMenu.AddSeparator(5);

            MiscMenu.AddLabel("Deadly Flourish (W) settings :");
            MiscMenu.Add("Plugins.Jhin.MiscMenu.WFowPrediction", new CheckBox("Kullan Konum tahmini"));
            MiscMenu.Add("Plugins.Jhin.MiscMenu.WAntiGapcloser", new CheckBox("Atilma yapan sampiyona kullan"));
            MiscMenu.AddSeparator(5);
            MiscMenu.AddLabel("Captive Audience (E) settings :");
            MiscMenu.Add("Plugins.Jhin.MiscMenu.EAntiGapcloser", new CheckBox("Atilma yapan sampiyona kullan"));
            ...
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili"));
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawQColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawW", new CheckBox("Goster W menzili"));
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawWColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawE", new CheckBox("Goster E menzili"));
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawEColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawR", new CheckBox("Goster R menzili"));
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawRColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.DrawInfo", new CheckBox("Goster bilgi")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Jhin.DrawingsMenu.InfoColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
