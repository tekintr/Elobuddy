...
namespace Marksman_Master.Plugins.Varus
{
    internal class Varus : ChampionPlugin
    {
        ...
        protected override void CreateMenu()
        {
            ...
            ComboMenu.Add("Plugins.Varus.ComboMenu.UseQ", new CheckBox("Kullan Q"));
            var qrange = ComboMenu.Add("Plugins.Varus.ComboMenu.QMinDistanceToTarget", new Slider("En az uzaklik kullanmak icin Q", 500, 0, 1250));
            ...
            ComboMenu.Add("Plugins.Varus.ComboMenu.UseE", new CheckBox("Kullan E"));
            ComboMenu.Add("Plugins.Varus.ComboMenu.UseEToProc", new CheckBox("Sadece 3 yuk varken E kullan", false));
            ComboMenu.AddSeparator(5);

            ComboMenu.AddLabel("Chain of Corruption (R) settings :");
            ComboMenu.Add("Plugins.Varus.ComboMenu.UseR", new CheckBox("Kullan R", false));
            ...
            HarassMenu.Add("Plugins.Varus.HarassMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) to use Q", 50, 1));
            ...
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.EnableLCIfNoEn", new CheckBox("Dusman yoksa lane temizleme aktif"));
            var scanRange = LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.ScanRange", new Slider("Dusman uzakligi", 1500, 300, 2500));
            ...
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.AllowedEnemies", new Slider("Izin verilen dusman sayisi", 1, 0, 5));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Lane clear settings :");
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.UseQInLaneClear", new CheckBox("Koridor temizlemede Q kullan", false));
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.MinMinionsHitQ", new Slider("En az kac miyona carpsin Q", 3, 1, 6));
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.UseEInLaneClear", new CheckBox("Koridor temizlemede E kullan", false));
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.MinMinionsHitE", new Slider("En az kac minyona carpsin E", 3, 1, 6));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Jungle clear settings :");
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.UseQInJungleClear", new CheckBox("Ormanda Q kullan", false));
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.UseEInJungleClear", new CheckBox("Ormanda E kullan"));
            LaneClearMenu.AddSeparator(5);

            LaneClearMenu.AddLabel("Mana settings :");
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.MinManaQ", new Slider("Gereken en az mana ({0}%) to use Q", 50, 1));
            LaneClearMenu.Add("Plugins.Varus.LaneClearMenu.MinManaE", new Slider("Gereken en az mana ({0}%) to use E", 50, 1));
            ...
            MiscMenu.Add("Plugins.Varus.MiscMenu.EnableKillsteal", new CheckBox("Aktif oldurme sekli"));
            ...
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawSpellRangesWhenReady", new CheckBox("Sadece hazir olan buyulerin menzilini goster"));
            DrawingsMenu.AddSeparator(5);

            DrawingsMenu.AddLabel("Piercing Arrow (Q) settings :");
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawQ", new CheckBox("Goster Q menzili"));
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawQColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawE", new CheckBox("Goster E menzili", false));
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawEColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawR", new CheckBox("Goster R menzili", false));
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawRColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
            ...
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DrawDamageIndicator", new CheckBox("Verilecek hasari goster")).OnValueChange += (a, b) =>
            {
                if (b.NewValue)
                    DamageIndicator.DamageDelegate = HandleDamageIndicator;
                else if (!b.NewValue)
            ...
            DrawingsMenu.Add("Plugins.Varus.DrawingsMenu.DamageIndicatorColor", new CheckBox("Renk Sec", false)).OnValueChange += (a, b) =>
            {
                if (!b.NewValue)
                    return;
